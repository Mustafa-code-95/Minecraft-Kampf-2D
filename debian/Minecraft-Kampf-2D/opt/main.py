...
t = ['e', 'm', 'c', 'd']
z = 0
e = ['assents/a', 'assents/b', 'assents/r.jpg', 'assents/s', 'assents/f', 'assents/g', 'assents/q', 'assents/k', 'assents/l', 'assents/o', 'assents/p', 'assents/z', 'assents/y', 'assents/v', 'assents/rt', 'assents/r.png', 'assents/mob.gif']
boxes = []
...
def update():
    global r, game_over, player, direction, leben, d, game_win, t, z, score_thread_started, rid, s, er, leben_text, game_over_text, her, name, ee
    ...
    if game_over == False and game_win == False:
        ...
        for mob in boxes:
            ...
            if player.intersects(mob).hit and ee != 1:
